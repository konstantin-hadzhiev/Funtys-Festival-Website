...
<div id="cont">
	<div id="title"><h3>You have forgotten your password?</h3></div>
	<div>
	<?php 
...
$email = $_POST['email']; 
$checkemail = mysql_query("SELECT id,firstname,password FROM users1 WHERE email='$email'"); 
...
$message = "Dear $firstname, this e-mail has been sent because you have forgotten your password.
...
mail($email, $subject, $message, "From: <admin@funtysmind.nl>nX-Mailer:PHP/" . phpversion()); 
header("Location:passemailsent.php"); 
}else{ 
header("Location:passmailnotsent.php");  }
}
?>
	
	<form action="passforgot.php" method="post">
	<table cellspacing="20">
	<h3 align="center">Please enter your e-mail!</h3>
	<tr>
		...
		<tr>
			<td></td>
			<td><input type="submit" name="sendpass" value="Send" class="btn" style="margin-left:60px;"></td></td>
